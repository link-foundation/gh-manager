...
- ab31a9a: Confirm deletions only from an explicit 404, detect over-broad patterns by what they match, and cache organization package settings in links notation.
...
- 8fda032: Add the gh-manager CLI: a globally installable browser-automation tool for the
